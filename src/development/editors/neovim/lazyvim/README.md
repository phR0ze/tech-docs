...
I'm going to shamelessly start from their configuration and build out my own using `lz.n` and Nix.

### Quick links
- [.. up dir](../README.md)
- [Overview](#overview)
  - [Nix Helpers](#nix-helpers)
- [NixOS Approach](#nixos-approach)
  - [LazyVim plugins](#lazyvim-plugin)
  - [Start with lz.n](#start-with-lz-n)
  - [0000-mini-icons](#0000-mini-icons)
...
### Nix Helpers
All of the existing Nix helpers are way too complicated an un-needed.
